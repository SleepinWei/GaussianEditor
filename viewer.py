...
class WebUI:
    def __init__(self, parser) -> None:
        ...
        self.gs_source = self.dataset.model_path
        ...
        with self.server.add_gui_folder("Render Setting"):
            ...
            # specify options
            self.renderer_options = ["comp_rgb","depth","opacity","normal"]
    ...
    def render(
        ...
        render_pkg["depth"] = depth / (depth.max() + 1e-5) # depth
