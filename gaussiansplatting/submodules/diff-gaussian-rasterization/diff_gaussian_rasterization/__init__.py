...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color,language_feature, depth, alpha, normal, distortion, radii, geomBuffer, binningBuffer, imgBuffer, ray_P, ray_M = _C.rasterize_gaussians(*args)
        ...
        return color,language_feature, radii, depth, alpha, normal, distortion, ray_P, ray_M

    @staticmethod
    def backward(ctx, grad_color,grad_out_language_feature, grad_radii, grad_depth, grad_alpha, grad_normal, grad_distortion, grad_P, grad_M):
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, language_feature_precomp=None, scales = None, rotations = None, cov3D_precomp = None):
        ...
        if language_feature_precomp is None:
            language_feature_precomp = torch.FloatTensor([])
